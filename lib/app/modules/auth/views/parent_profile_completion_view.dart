    ...
    return Scaffold(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Welcome Message
                  Text(
                    LocaleKeys.pages_familyAuth_profileCompletion_heading.tr,
                    style: TextStyle(
                  ...
                  Text(
                    LocaleKeys
                        .pages_familyAuth_profileCompletion_instructions.tr,
                    style: TextStyle(
                  ...
                  // Full Name Field
                  Text(
                    LocaleKeys.pages_familyAuth_profileCompletion_nameLabel.tr,
                    style: TextStyle(
                  ...
                  CustomTextFormField(
                    ...
                    hintText: LocaleKeys
                        .pages_familyAuth_profileCompletion_namePlaceholder.tr,
                  ...
                  Text(
                    LocaleKeys
                        .pages_familyAuth_profileCompletion_deviceUsageLabel.tr,
                    style: TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: k14Double.sp,
                      color: Color(0xFF212121),
                        ...
                        child: Column(
                          children: DeviceMode.values.map((mode) {
                            return RadioListTile<DeviceMode>(
                              ...
                              value: mode,
                              groupValue: controller.selectedDeviceMode.value,
                              activeColor: Color(0xFF1976D2),
                              onChanged: (DeviceMode? value) {
                                if (value != null) {
                                  controller.selectedDeviceMode.value = value;
                                }
                              },
                            );
                          }).toList(),
                  ...
                  Text(
                    LocaleKeys
                        .pages_familyAuth_profileCompletion_passwordLabel.tr,
                    style: TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: k14Double.sp,
                      color: Color(0xFF212121),
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomButton.primary(
          text: LocaleKeys
              .pages_familyAuth_profileCompletion_createAccountButton.tr,
